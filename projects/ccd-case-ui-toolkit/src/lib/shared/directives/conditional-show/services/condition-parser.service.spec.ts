  ...
  describe('parse', () => {
    ...
    describe('parse simple, enclosed compound formulas', () => {
      const testCases = [
        ...
        {
          input: 'stf24wPreviousStatusWasYesAutoGenerated!="Yes" AND ((currentCaseStateVisibleToLegalRepresentative="appealSubmitted") OR (currentCaseStateVisibleToLegalRepresentative="pendingPayment"))',
          expected: [
            { fieldReference: 'stf24wPreviousStatusWasYesAutoGenerated', comparator: '!=', value: 'Yes' },
            'AND',
            [
              { fieldReference: 'currentCaseStateVisibleToLegalRepresentative', comparator: '=', value: 'appealSubmitted' },
              'OR',
              { fieldReference: 'currentCaseStateVisibleToLegalRepresentative', comparator: '=', value: 'pendingPayment' }
            ]
          ]
        },
        {
