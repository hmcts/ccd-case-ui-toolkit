export enum UpdateFlagErrorMessage {
  ...
  FLAG_COMMENTS_CHAR_LIMIT_EXCEEDED = 'Comments for this flag must be 1000 characters or fewer',
  ...
  STATUS_REASON_CHAR_LIMIT_EXCEEDED = 'Comments must be 1000 characters or fewer',
  NONE = ''
}
