    ...
    caseFieldMockData.value = [
      {
        ...
        value: {
          document_url: 'http://dm-store-aat.service.core-compute-aat.internal/documents/e5366837-b3f6-492d-acbf-548730625e8f',
          document_filename: 'Screenshot 2023-06-01 at 16.07.06.png',
          document_binary_url: 'http://dm-store-aat.service.core-compute-aat.internal/documents/e5366837-b3f6-492d-acbf-548730625e8f/binary'
        }
      },
      {
        id: '725bf4a7-9e4c-4132-b5c1-f8028cb83459',
        value: {
          document_url: 'http://dm-store-aat.service.core-compute-aat.internal/documents/f50ccd7a-7f28-40f3-b5f9-7ad2f6425506',
          document_filename: 'dummy.pdf',
          document_binary_url: 'http://dm-store-aat.service.core-compute-aat.internal/documents/f50ccd7a-7f28-40f3-b5f9-7ad2f6425506/binary'
        }
      }
    ];
