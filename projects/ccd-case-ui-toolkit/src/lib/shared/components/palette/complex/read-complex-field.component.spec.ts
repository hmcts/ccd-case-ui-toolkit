...
const inputs: string[] = ['caseField', 'caseFields', 'context', 'valueOrigin', 'formGroup', 'topLevelFormGroup', 'idPrefix'];
...
describe('ReadComplexFieldComponent', () => {
  ...
  function setupComponents() {
    ...
    readComplexFieldNewTableComponentMock = MockComponent({
      ...
      inputs: ['caseField', 'context', 'valueOrigin', 'formGroup', 'topLevelFormGroup', 'idPrefix']
    });
  }
