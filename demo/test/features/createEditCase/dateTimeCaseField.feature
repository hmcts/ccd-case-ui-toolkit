...
Feature: Case field Date and Datetime picker
    ...
    Scenario: Date time picker not displayed when display_context_parametr is null
    ...
    Scenario: Date time picker is displayed when displat_context_parametr is has ENTRY
    ...
    Scenario: Multiple datetime fields in page
        ...
        Given I set field properties for field with id "dt1" in event "muliDateFields"
            | key                       | value                                                                         |
            | display_context_parameter | #DATETIMEENTRY(YYYY-MM-DD hh:mm:ss A),#DATETIMEDISPLAY(YYYY-MM-DD hh:mm:ss A) |

        Given I set field properties for field with id "dt2" in event "muliDateFields"
            | key                       | value                                                |
            | display_context_parameter | #DATETIMEENTRY(YYYY-MM),#DATETIMEDISPLAY(YYYY-MM-DD) |
        ...
        Then I validate request body "eventValidateReq" of event validate api
            ...
            | $.data.dt2     | 2020-01-01T00:00:00.000 |
    ...
    Scenario: Date and Datetime in complex
        ...
        Given I add fields to page "page1" in event "muliDateFields"
            ...
            | f2.dt1   | DateTime | Date Mandatory      |
            | f2.dt2   | Date     | DateTime Optional   |
            | f2.dt3   | Date     | DateTime readonly   |
            | f2.dt4   | Date     | DateTime readonly 2 |
        ...
        Given I set field properties for field with id "f2.dt1" in event "muliDateFields"
            | key                       | value                                                         |
            | display_context_parameter | #DATETIMEDISPLAY(YYYY-MM),#DATETIMEENTRY(YYYY-MM-DD hh:mm:ss) |
        Given I set field properties for field with id "f2.dt2" in event "muliDateFields"
            | key                       | value                                                   |
            | display_context_parameter | #DATETIMEDISPLAY(YYYY-MM-DD),#DATETIMEENTRY(YYYY-MM-DD) |
        Given I set field properties for field with id "f2.dt3" in event "muliDateFields"
            | key                       | value                                          |
            | display_context_parameter | #DATETIMEDISPLAY(YYYY),#DATETIMEENTRY(YYYY-MM) |

        Given I set field properties for field with id "f2.dt4" in event "muliDateFields"
            | key                       | value                                                           |
            | display_context_parameter | #DATETIMEDISPLAY(YYYY-MM-DD hh:mm:ss a),#DATETIMEENTRY(YYYY-MM) |
        ...
        Given I set caseField values in event config "muliDateFields"
            ...
            | f2.dt4 | 2021-10-10T11:11:11.000Z |
        ...
        Then I validate datetime field values in case edit page
            | cssSelector | value               |
            | #f2_f2 #dt1 | 2020-12-12 12:12:12 |
            | #f2_f2 #dt2 | 2021-11-11          |
        Then I validate date time readonly field
            | label               | value                  |
            | DateTime readonly   | 2021                   |
            | DateTime readonly 2 | 2021-10-10 11:11:11 AM |
    ...
    Scenario: Date and Date time fields in Case list
        ...
        Given I add case field columns to caselist config "caseListtest"
            ...
            | caseName      | Case name      |                                          |
            | dateTime1     | Datetime 12    | #DATETIMEDISPLAY(YYYY-MMM-DD hh:mm:ss a) |
        ...
        Given I add case list data rows for config "caseListtest"
            ...
            | 12345677      | case 1   | 2021-07-23T15:19:10.093 | 2021-07-23T15:19:10.093 | 2021-07-23T15:19:10.093 | 2021-07-23T15:19:10.093 | 2021-07-23T15:19:10.093 | 2021-07-23T15:19:10.093 |
            | 12345678      | case 2   | 2021-07-23T15:19:10.093 | 2021-07-23T15:19:10.093 | 2021-07-23T15:19:10.093 | 2021-07-23T15:19:10.093 | 2021-07-23T15:19:10.093 | 2021-07-23T15:19:10.093 |
            | 12345679      | case 3   | 2021-07-23T15:19:10.093 | 2021-07-23T15:19:10.093 | 2021-07-23T15:19:10.093 | 2021-07-23T15:19:10.093 | 2021-07-23T15:19:10.093 | 2021-07-23T15:19:10.093 |
        ...
        Then I validate case list column values
            ...
            | 12345677       | case 1    | 2021-Jul-23 03:19:10 PM | 2021-07 23 15:19:10 | 2021-07-23 03 PM | 2021-07-23 | 2021-07 | 2021   |
            | 12345678       | case 2    | 2021-Jul-23 03:19:10 PM | 2021-07 23 15:19:10 | 2021-07-23 03 PM | 2021-07-23 | 2021-07 | 2021   |
    ...
    Scenario: Date and Datetime fields in workbasket
        ...
        Given I add case field to workbasket config "workBasketConfig"
            ...
            | Date field | date2 | Date     | #DATETIMEENTRY(YYYY-MM)               |
            | Date field | date3 | DateTime |                                       |
            | Date field | date4 | DateTime | #DATETIMEENTRY(YYYY-MM-DD hh:mm:ss A) |
