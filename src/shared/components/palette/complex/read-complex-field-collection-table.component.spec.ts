...
describe('ReadComplexFieldCollectionTableComponent', () => {
  ...
  describe('when values split accross children fields', () => {
    ...
    let textFieldType: FieldType = createFieldType('Text', 'Text');
    let numberFieldType: FieldType = createFieldType('Number', 'Number');
    ...
    const FIELD_TYPE_WITH_VALUES: FieldType = {
      ...
      complex_fields: [
        ...
        newCaseField('AddressLine2', 'Line 2', null, numberFieldType, 'OPTIONAL').withValue('111 East India road').build(),
        newCaseField('AddressPostcode', 'Post code', null, textFieldType, 'OPTIONAL').withValue('tw45ed').build(),
      ]
    };
